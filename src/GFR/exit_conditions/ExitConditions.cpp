#include "gfr/exit_conditions/ExitConditions.hpp"
#include "gfr/exit_conditions/CustomExitCondition.hpp"
#include "gfr/exit_conditions/PrepLineExitCondition.hpp"
#include "gfr/exit_conditions/SettleExitCondition.hpp"
#include "gfr/exit_conditions/TimeOutExitCondition.hpp"
#include "gfr/exit_conditions/ToleranceAngularExitCondition.hpp"
#include "gfr/exit_conditions/ToleranceExitCondition.hpp"
#include "gfr/exit_conditions/ToleranceLinearExitCondition.hpp"
...
void ExitConditions::set_target(gfr::Pose new_target) {
...
bool ExitConditions::is_met(gfr::Pose current_pose, bool thru) {
    for (auto ec : this->conditions) {
...
bool ExitConditions::all_met(gfr::Pose current_pose, bool thru) {
    for (auto ec : this->conditions) {
        if (!ec->is_met(current_pose, thru)) {
            return false;
        }
